...
import { getAllProjects, saveProject, deleteProject } from "../db.js";
    ...
    >
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          sub='Tap "+ New Project" to get started'
        />
      ) : (
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {projects.map((p) => (
            ...
            >
              ...
              >
                <Btn variant="ghost" size="sm" onClick={(e) => openEdit(p, e)}>
                  Edit
                </Btn>
                <Btn
                  size="sm"
      ...
      {showModal && (
        ...
        >
          ...
          />
          <Btn fullWidth onClick={handleSave} size="lg">
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    All data — Materials, Labour, Misc, Payments &amp; Summary
                    in separate sheets
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  >
                    Formatted A4 report — easy to share, print or view on mobile
                  </div>
                </div>
              </button>
            </div>
  ...
  >
    ...
    >
      ...
      <div style={{
        ...
        ⚠️ This will permanently delete the project and <strong>all its entries</strong> — materials, labour, payments & misc.
      </div>
